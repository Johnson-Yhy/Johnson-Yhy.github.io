...
$.ajax({
    ...
    data: {
        key: 'BNBBZ-OREKZ-J7JXK-ZOX4O-5IFZ6-CSFPH',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(103.20915 , 35.59573 , ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
